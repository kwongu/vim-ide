...
echo "tip: <C-g> 는 두 번 묻고 찾습니다. 먼저 찾을 말(커서 밑 낱말 또는 고른 글자),"
echo "     Enter 뒤에 찾을 경로(기본은 지금 파일의 디렉터리, <Tab> 완성)."
echo "     둘 중 어디서든 Esc 면 그만둡니다 (g:relationview_grep_ask_dir = 0 이면"
echo "     경로를 묻지 않습니다)"
